...
# list = ["/home/andy/ocr_knn/initial_tasks/task3/data/train_digits2_jpg/"+file for file in os.listdir('/home/andy/ocr_knn/initial_tasks/task3/data/train_digits2_jpg')]
#
# list.sort()
#
