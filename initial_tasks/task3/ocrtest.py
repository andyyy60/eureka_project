...
def get_exif(fn,pictype):
	...
	#print 'All tags in jpeg metadata:\n{0}'.format(tags)
        ...
        if pictype == 1:
            temp = crop_and_recognize.run_c1(fullfname, 'data/data_files/camera_1/')
        elif pictype == 2:
            temp = crop_and_recognize.run_c2(fullfname, 'data/data_files/camera_2/')
        elif pictype == 3:
            temp = crop_and_recognize.run_c3(fullfname, 'data/data_files/camera_3/')
        else:
